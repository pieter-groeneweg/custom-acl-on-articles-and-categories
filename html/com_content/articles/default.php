		...
		<?php else : ?>
			<table class="table table-striped" id="articleList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					//pieter//$canChange  = $user->authorise('core.edit.state', 'com_content.article.' . $item->id) && $canCheckin;
					
					//pieter//set value canChange based on canEdit or canEditOwn
					...
					<?php
						if($canChange && $saveOrder) {
							echo '<tr class="row'.$i % 2 .'" sortable-group-id="'.$item->catid.'">';
						}
						else {
							echo '<tr class="cow'.$i.'" non-sortable-group-id="'.$item->catid.'">';
						}
					?>
						<td class="order nowrap center hidden-phone">
							...
							<?php if ($canChange && $saveOrder) : //pieter//moved up the condition to include sortable handler in the trick ?>
